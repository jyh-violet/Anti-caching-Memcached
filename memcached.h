...
#define IsWarm(it)  ((it->read_count > HOT_ITEM_R_COUNT ))
#define IsHotForSwap(it)  ( (it->read_count > HOT_ITEM_R_COUNT*NVM_DRAM_R))
...
typedef struct {
    union {
        struct {
            ...
            unsigned short page_version; /* from IO header */
