...
for WORKLOAD_TYPE in a b c; do
  ...
  mv data/load_${KEY_TYPE}_workload${WORKLOAD_TYPE} data/load${WORKLOAD_TYPE}_zipf_int_50M.dat
  mv data/txn_${KEY_TYPE}_workload${WORKLOAD_TYPE} data/txns${WORKLOAD_TYPE}_zipf_int_50M.dat
done
